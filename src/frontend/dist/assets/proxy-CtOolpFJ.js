...
Service({
  "getOrderById": Func([Nat], [Opt(Order)], ["query"]),
  "getOrders": Func([], [Vec(Order)], ["query"]),
  "placeOrder": Func(
    [Text, Text, Text, Vec(OrderItem)],
    [Nat],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    "getOrderById": IDL2.Func([IDL2.Nat], [IDL2.Opt(Order2)], ["query"]),
    "getOrders": IDL2.Func([], [IDL2.Vec(Order2)], ["query"]),
    "placeOrder": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Vec(OrderItem2)],
      [IDL2.Nat],
      []
    )
  });
